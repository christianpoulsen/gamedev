...
export const tasks: Task[] = [
  ...
  },
  {
    ...
    type: TaskType.CUSTOMER_DEVELOPMENT,
    question:
      "All 5 parents tell you that their kids like to either play games or watch TV on their tablets. What's your conclusion?",
    options: [
      {
  ...
  },
  {
    ...
    type: TaskType.CUSTOMER_DEVELOPMENT,
    question:
      "3 parents think its demanding to keep an eye on their kids. 2 parents think they spend a lot of time on their upbringing. Whats your conclusion?",
    options: [
      {
      ...
      {
        decision:
          "A key feature of the smartwatch should be reminders and habit building",
        consequence: { cd: 2 }
      },
      { decision: "You find the results inconclusive", consequence: { cd: 2 } }
    ]
  },
  {
    ...
    type: TaskType.CUSTOMER_DEVELOPMENT,
    question:
      "All 5 parents do think the smartwatch should include features like fitnesstracking, calls and messaging. Whats your conclusion?",
    options: [
      {
        decision:
          "A key feature of the smartwatch should be tracking the daily fitness level",
        consequence: { cd: 1 }
      },
      {
  ...
  },
  {
    ...
    type: TaskType.CUSTOMER_DEVELOPMENT,
    question:
      "You can't communicate with the kids, but you observe them using devices for gaming and watching TV shows. What's your conclusion?",
    options: [
      {
        decision: "A key feature of the smartwatch should be playing games",
        consequence: { cd: 1 }
  ...
  },
  {
    ...
    text:
      "To gain insight in your customers needs for your product, you build a fake webshop and advertise it",
    question:
      "Your campaing consists of a fake webpage/webshop and an online advertisement campaign. How much do you want to do yourself?",
    options: [
      {
  ...
  },
  {
    ...
    type: TaskType.PRODUCT_READINESS,
    question:
      "Which of the following product key features would you like to test?",
    options: [
      {
  ...
  },
  {
    ...
    result: {
      takeAway:
        "After reviewing your add campaign the consultants conclude that the result is negative. The interest among your potential customers is not strong enough",
      sum: ResultSum.NEGATIVE
    }
  },
  {
